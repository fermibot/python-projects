...
class TestBase(TestCase):
    ...
    def common_api_test(self, funcname, args, kwargs, expected_args, expected_kwargs):
        # Create a fitbit_internal object, call the named function on it with the given
...
class APITest(TestBase):
    """
    Tests for python-fitbit_internal API, not directly involved in getting
    authenticated
    """
...
class CollectionResourceTest(TestBase):
    ...
    def test_body(self):
        ...
        with mock.patch('fitbit_internal.api.Fitbit._COLLECTION_RESOURCE') as coll_resource:
...
class DeleteCollectionResourceTest(TestBase):
    ...
    def test_delete_foods_log(self):
        ...
        # since the __init__ is going to set up references to it
        with mock.patch('fitbit_internal.api.Fitbit._DELETE_COLLECTION_RESOURCE') as delete_resource:
...
class ResourceAccessTest(TestBase):
    ...
    def test_recent_activities(self):
        ...
        with mock.patch('fitbit_internal.api.Fitbit.activity_stats') as act_stats:
            fb = Fitbit('x', 'y')
