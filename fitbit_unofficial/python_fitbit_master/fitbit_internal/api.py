...
class FitbitOauth2Client(object):
    ...
    def authorize_token_url(self, scope=None, redirect_uri=None, **kwargs):
        ...
        browser.
            ...
            - redirect_uri: url to which the response will posted. required here
              unless you specify only one Callback URL on the fitbit_internal app or
    ...
    def fetch_access_token(self, code, redirect_uri=None):
        ...
        """Step 2: Given the code from fitbit_internal from step 1, call
        fitbit_internal again and returns an access token object. Extract the needed
...
class Fitbit(object):
    ...
    make sure to pass the `redirect_uri` keyword arg so fitbit_internal will know where
